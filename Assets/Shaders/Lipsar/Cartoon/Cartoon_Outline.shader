Shader "Lipsar/Cartoon_Outline"
{
    Properties
    {
		...
		[Toggle] _Transperancy ("Use Transperancy", Float) = 0
		...
		/*[Header(FakeLight)][Space(10)]
		[Toggle] _FakeLight("Enable", Float) = 0
		_FakeLightDirection("Light Direction", Vector) = (0,0,0,0)
		_FakeLightSoftness("Light Softness", Range(0, 1)) = 0.5
		_FakeLightSoftness2("Light Softness", Range(0.01, 1)) = 0.5
		_FakeLightColor("Light Color", Color) = (1,1,1,1)

		[Header(_________________________________________________________________________________________________________________________________________________________________________)]
		[Header(Rim)][Space(10)]
		[Toggle] _Rim("Enable", Float) = 0
		_RimColor("Rim Color", Color) = (1.0, 0.5, 0.5, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _TRANSPERANCY_ON
            //#pragma shader_feature _FAKELIGHT_ON
